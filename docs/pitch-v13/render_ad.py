...
def render():
 ...
 v.run(['-i',R/'carestead-ad-v13.mp4','-vf','scale=1280:720','-c:v','libvpx-vp9','-crf',30,'-b:v',0,'-deadline','realtime','-cpu-used',6,'-c:a','libopus','-b:a','128k',R/'carestead-ad-v13.webm'])
