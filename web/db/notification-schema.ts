export const notificationSchema = [
  `CREATE TABLE IF NOT EXISTS pushover_preferences (recipient_id TEXT NOT NULL, member_id TEXT NOT NULL, user_key TEXT NOT NULL, updated_at TEXT NOT NULL, PRIMARY KEY(recipient_id,member_id))`,
