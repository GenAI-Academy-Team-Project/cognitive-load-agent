export const notificationSchema = [
  `CREATE TABLE IF NOT EXISTS list_dismissals (recipient_id TEXT NOT NULL, member_id TEXT NOT NULL, entity_type TEXT NOT NULL, entity_id TEXT NOT NULL, dismissed_at TEXT NOT NULL, PRIMARY KEY(recipient_id,member_id,entity_type,entity_id))`,
